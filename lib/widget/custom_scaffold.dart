...
import 'package:multifunction_camera/theme/app_theme_model.dart';
...
class CustomScaffold extends StatelessWidget {
  const CustomScaffold({
    ...
    this.restorationId,
    this.bottomMenuHeight = 400,
    this.bottomMenuContent,
    this.stackWidgetContent,
    this.hideDialog,
  }) : super(key: key);

  /// build background of CustomScaffold.
  /// 根据所选主题修改，参考 [getCommonBgDecoration]
  final Decoration Function(
    BuildContext context,
    AppThemeModel model,
  )? buildDecoration;
  final double bottomMenuHeight;
  final Widget? bottomMenuContent;
  final Widget? stackWidgetContent;

  ///回调函数
  final GestureTapCallback? hideDialog;
